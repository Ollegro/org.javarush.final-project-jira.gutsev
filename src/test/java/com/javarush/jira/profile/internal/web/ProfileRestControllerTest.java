...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    private static final String REST_URL_USER_PROFILE = ProfileRestController.REST_URL;
    ...
    void getUnAuth() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_USER_PROFILE))
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_USER_PROFILE))
                ...
                .andExpect(MATCHER_TWO_PROFILE.contentJson(USER_PROFILE_TO));
    ...
    void getGuest() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_USER_PROFILE))
                ...
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MATCHER_TWO_PROFILE.contentJson(GUEST_PROFILE_EMPTY_TO));
    }

    @Test
    @WithUserDetails(value = USER_MAIL)
    void updateNoBody() throws Exception {
        perform(MockMvcRequestBuilders.post(REST_URL_USER_PROFILE)
    ...
    void updateWithBadTo(ProfileTo invalidTo) throws Exception {
        perform(MockMvcRequestBuilders.put(REST_URL_USER_PROFILE)
                .contentType(MediaType.APPLICATION_JSON)
